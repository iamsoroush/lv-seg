...
class DataSetCreator:
    ...
    def __init__(self, list_images_dir, list_labels_dir, sample_weights=None, to_fit=True):
        ...
        Args:
            list_images_dir: list of images director
            list_labels_dir: list of labels directory
            sample_weights: sample weights for each instance
            to_fit: weather it is the tests set od train/validation set
        """
    ...
    def _create_sample_weights(self, label):
        ...
        Args:
            label: input label, numpy.array
        Returns:
            sample_weights, tf.int32
        """
    ...
    def _load_data(self, x_path, y_path):
        ...
        Args:
             x_path: images directory, str
             y_path: labels directory, str
        Returns:
             a tuple of (image, label, sample_weights), or (image, label, data_id)
        """
    ...
    def _parse_function(self, x, y):
        ...
        Args:
             x: images directory, list
             y: labels directory, list
        Returns:
             tf.py_function
        """
        if self.to_fit:
